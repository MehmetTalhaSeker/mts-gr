...
func (pc *PostCreate) SetShortDescr(s string) *PostCreate {
	pc.mutation.SetShortDescr(s)
	return pc
}
...
func (pc *PostCreate) check() error {
	...
	if _, ok := pc.mutation.ShortDescr(); !ok {
		return &ValidationError{Name: "short_descr", err: errors.New(`ent: missing required field "Post.short_descr"`)}
	}
	if v, ok := pc.mutation.ShortDescr(); ok {
...
func (pc *PostCreate) createSpec() (*Post, *sqlgraph.CreateSpec) {
	...
	if value, ok := pc.mutation.ShortDescr(); ok {
		_spec.SetField(post.FieldShortDescr, field.TypeString, value)
		_node.ShortDescr = value
	}
