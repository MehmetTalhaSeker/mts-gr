...
func (pu *PostUpdate) SetShortDescr(s string) *PostUpdate {
	pu.mutation.SetShortDescr(s)
	return pu
}

// SetNillableShortDescr sets the "short_descr" field if the given value is not nil.
func (pu *PostUpdate) SetNillableShortDescr(s *string) *PostUpdate {
	if s != nil {
		pu.SetShortDescr(*s)
	}
	return pu
...
func (pu *PostUpdate) check() error {
	...
	if v, ok := pu.mutation.ShortDescr(); ok {
		if err := post.ShortDescrValidator(v); err != nil {
			return &ValidationError{Name: "short_descr", err: fmt.Errorf(`ent: validator failed for field "Post.short_descr": %w`, err)}
		}
	}
...
func (pu *PostUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := pu.mutation.ShortDescr(); ok {
		_spec.SetField(post.FieldShortDescr, field.TypeString, value)
	}
...
// SetShortDescr sets the "short_descr" field.
func (puo *PostUpdateOne) SetShortDescr(s string) *PostUpdateOne {
	puo.mutation.SetShortDescr(s)
	return puo
}

// SetNillableShortDescr sets the "short_descr" field if the given value is not nil.
func (puo *PostUpdateOne) SetNillableShortDescr(s *string) *PostUpdateOne {
	if s != nil {
		puo.SetShortDescr(*s)
	}
	return puo
...
func (puo *PostUpdateOne) check() error {
	...
	if v, ok := puo.mutation.ShortDescr(); ok {
		if err := post.ShortDescrValidator(v); err != nil {
			return &ValidationError{Name: "short_descr", err: fmt.Errorf(`ent: validator failed for field "Post.short_descr": %w`, err)}
		}
	}
...
func (puo *PostUpdateOne) sqlSave(ctx context.Context) (_node *Post, err error) {
	...
	if value, ok := puo.mutation.ShortDescr(); ok {
		_spec.SetField(post.FieldShortDescr, field.TypeString, value)
	}
